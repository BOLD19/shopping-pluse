  ...
  return (
    <div className="w-full bg-white">
      ...
      <section className="relative w-full min-h-screen px-4 flex flex-col items-center justify-center overflow-hidden">
        {/* Градиент и фон */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#f0f9ff] via-white to-white"></div>
        <div className="absolute inset-0 bg-grid-blue/[0.02] bg-[length:20px_20px]"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-[#0088f5]/10 blur-[120px]"></div>
        
        <div className="container relative z-10 max-w-6xl mx-auto pt-20 pb-16 md:pt-32 md:pb-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="text-center lg:text-left">
              <h1 className="text-4xl md:text-6xl font-bold text-[#0f172a] mb-8">
              ...
              <Link 
                href="#start"
                className="inline-flex items-center px-8 py-4 text-lg font-medium text-white bg-gradient-to-r from-[#0088f5] to-[#0979ff] rounded-xl shadow-[0_8px_30px_rgba(0,136,245,0.2)] hover:shadow-[0_8px_30px_rgba(0,136,245,0.4)] transition-all duration-300"
              >
                Запустить магазин
            ...
            <div className="relative">
              ...
              <div className="relative bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-2xl">
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <Store className="h-8 w-8 text-[#0088f5]" />
                      <span className="text-[#0f172a] font-medium">Ваш магазин</span>
                    </div>
                    <div className="flex space-x-2">
                      <div className="w-3 h-3 rounded-full bg-[#0088f5]"></div>
                      <div className="w-3 h-3 rounded-full bg-[#0979ff]"></div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-[#f0f9ff] p-4 rounded-xl">
                      <div className="bg-white p-3 rounded-lg text-center mb-3">
                        <Truck className="h-6 w-6 text-[#0088f5] mx-auto mb-2" />
                        <p className="text-sm text-[#64748b]">Доставка</p>
                      </div>
                      <div className="bg-white p-3 rounded-lg text-center">
                        <CreditCard className="h-6 w-6 text-[#0088f5] mx-auto mb-2" />
                        <p className="text-sm text-[#64748b]">Оплата</p>
                      </div>
                    </div>
                    
                    <div className="bg-[#f0f9ff] p-4 rounded-xl">
                      <div className="bg-white p-3 rounded-lg text-center mb-3">
                        <ShoppingBag className="h-6 w-6 text-[#0088f5] mx-auto mb-2" />
                        <p className="text-sm text-[#64748b]">Товары</p>
                      </div>
                      <div className="bg-white p-3 rounded-lg text-center">
                        <Briefcase className="h-6 w-6 text-[#0088f5] mx-auto mb-2" />
                        <p className="text-sm text-[#64748b]">Бренд</p>
                      </div>
                    </div>
                  </div>

                  <div className="bg-gradient-to-r from-[#0088f5] to-[#0979ff] p-4 rounded-xl">
                ...
                <div className="mt-6 flex justify-center">
                  <span className="inline-flex items-center text-sm text-[#0088f5]">
              ...
              {/* 3D Elements */}
              <div className="absolute -top-10 -right-10 w-32 h-32 bg-gradient-to-br from-[#0088f5]/20 to-[#0979ff]/20 rounded-2xl transform rotate-12 backdrop-blur-xl"></div>
              <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-gradient-to-br from-[#0088f5]/20 to-[#0979ff]/20 rounded-2xl transform -rotate-12 backdrop-blur-xl"></div>
            </div>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-[#f0f9ff] rounded-xl p-6">
                  <div className="bg-gradient-to-br from-[#0088f5] to-[#0979ff] w-12 h-12 rounded-xl flex items-center justify-center mb-4">
                    <Settings className="h-6 w-6 text-white" />
                  </div>
                  <h3 className="text-lg font-bold text-[#0f172a] mb-2">Конструктор без кода</h3>
                  <p className="text-[#64748b]">Создавайте магазин без знаний программирования</p>
                </div>
                ...
                <div className="bg-[#f0f9ff] rounded-xl p-6">
                  ...
                  <h3 className="text-lg font-bold text-[#0f172a] mb-2">Оплата и рассрочка</h3>
                  <p className="text-[#64748b]">Встроенный эквайринг и рассрочка от Pluse</p>
                </div>
                ...
                <div className="bg-[#f0f9ff] rounded-xl p-6">
                  ...
                  <h3 className="text-lg font-bold text-[#0f172a] mb-2">Доставка</h3>
                  <p className="text-[#64748b]">Интеграция с популярными службами доставки</p>
                </div>
                ...
                <div className="bg-[#f0f9ff] rounded-xl p-6">
                  ...
                  <h3 className="text-lg font-bold text-[#0f172a] mb-2">Панель заказов</h3>
                  <p className="text-[#64748b]">Удобное управление всеми заказами</p>
                </div>
              </div>
            </div>

            <div className="relative">
              <div className="absolute -top-20 -right-20 w-72 h-72 bg-[#0088f5]/10 rounded-full blur-3xl"></div>
              <div className="relative bg-white rounded-xl p-8 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.06)]">
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="bg-[#f0f9ff] rounded-xl p-4">
                    <h4 className="text-2xl font-bold text-[#0f172a] mb-2">0%</h4>
                    <p className="text-[#64748b]">Комиссия за заказы</p>
                  </div>
                  <div className="bg-[#f0f9ff] rounded-xl p-4">
                    <h4 className="text-2xl font-bold text-[#0f172a] mb-2">1 день</h4>
                    <p className="text-[#64748b]">Запуск магазина</p>
                  </div>
                </div>
                
                <div className="space-y-4">
                  <div className="flex items-center text-[#64748b]">
                    <CheckCircle2 className="h-5 w-5 text-[#0088f5] mr-3" />
      ...
      {/* Features Section */}
      <section className="relative py-24 overflow-hidden bg-[#f0f9ff]">
        <div className="absolute inset-0 bg-grid-blue/[0.02] bg-[length:20px_20px]"></div>
        ...
        <div className="container relative z-10 max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="group bg-white rounded-xl p-8 border border-gray-100 hover:border-[#0088f5] transition-colors shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.1)]">
              <div className="bg-gradient-to-br from-[#0088f5] to-[#0979ff] w-16 h-16 rounded-xl flex items-center justify-center mb-6">
                <ShoppingBag className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-[#0f172a] mb-4">Интернет-магазин с корзиной</h3>
              <p className="text-[#64748b]">Готовый магазин с каталогом, корзиной и оформлением заказа</p>
            </div>
            ...
            <div className="group bg-white rounded-xl p-8 border border-gray-100 hover:border-[#0088f5] transition-colors shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.1)]">
              ...
              <h3 className="text-xl font-bold text-[#0f172a] mb-4">Уникальный домен</h3>
              <p className="text-[#64748b]">Подключите свой домен или получите поддомен pluse.shopping</p>
            </div>
            ...
            <div className="group bg-white rounded-xl p-8 border border-gray-100 hover:border-[#0088f5] transition-colors shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.1)]">
              ...
              <h3 className="text-xl font-bold text-[#0f172a] mb-4">0% комиссия за заказы</h3>
              <p className="text-[#64748b]">Никаких скрытых комиссий и платежей с оборота</p>
            </div>
            ...
            <div className="group bg-white rounded-xl p-8 border border-gray-100 hover:border-[#0088f5] transition-colors shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.1)]">
              ...
              <h3 className="text-xl font-bold text-[#0f172a] mb-4">Эквайринг и рассрочка</h3>
              <p className="text-[#64748b]">Встроенные платежи и рассрочка от Pluse</p>
            </div>
            ...
            <div className="group bg-white rounded-xl p-8 border border-gray-100 hover:border-[#0088f5] transition-colors shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.1)]">
              ...
              <h3 className="text-xl font-bold text-[#0f172a] mb-4">Telegram и WhatsApp</h3>
              <p className="text-[#64748b]">Подключение мессенджеров для общения с клиентами</p>
            </div>
            ...
            <div className="group bg-white rounded-xl p-8 border border-gray-100 hover:border-[#0088f5] transition-colors shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.1)]">
              ...
              <h3 className="text-xl font-bold text-[#0f172a] mb-4">Доставка и управление</h3>
              <p className="text-[#64748b]">Интеграция с службами доставки и панель управления</p>
            </div>
          </div>
        </div>
      </section>
